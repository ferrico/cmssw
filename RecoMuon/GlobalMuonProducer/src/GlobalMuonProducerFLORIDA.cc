...
//
GlobalMuonProducerFLORIDA::GlobalMuonProducerFLORIDA(const ParameterSet& parameterSet) {

  LogTrace("Muon|RecoMuon|GlobalMuonProducerFLORIDA") << "constructor called" << endl;
...
// destructor
//
GlobalMuonProducerFLORIDA::~GlobalMuonProducerFLORIDA() {
...
// reconstruct muons
//
void GlobalMuonProducerFLORIDA::produce(Event& event, const EventSetup& eventSetup) {
  const string metname = "Muon|RecoMuon|GlobalMuonProducerFLORIDA";  
